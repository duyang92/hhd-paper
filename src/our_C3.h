...
typedef struct cell
{
    ...
    uint32_t right_right_child_count;
    uint32_t left_right_child_count;
} CELL;
...
#if MEMORY==256
#define BUCKET_NUM 3084
#elif MEMORY==128
#define BUCKET_NUM 1542
#elif MEMORY==512
#define BUCKET_NUM 6168
#elif MEMORY==1024
#define BUCKET_NUM 12336
#endif
