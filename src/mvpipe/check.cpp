...
int main(int argc,char *argv[])
{
    ...
    fin.close();
    #ifdef BIT
    fin.open("flow_actual_size_bit_2016_"+to_string(threshold));
    #else
    fin.open("flow_actual_size_byte_2016_"+to_string(threshold));
    #endif
    ...
    fin.close();
    #ifdef BIT
    fin.open("flow_conditional_count_bit_2016_"+to_string(threshold));
    #else
    fin.open("flow_conditional_count_byte_2016_"+to_string(threshold));
    #endif
