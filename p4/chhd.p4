...
control SwitchIngress(
    ...
    action shift(bit<32> mask1,bit<32> mask2) {
        meta.src_ip_mask = meta.src_ip_mask & mask1;
        hdr.ipv4.src_addr = hdr.ipv4.src_addr & mask2;
    }
    ...
    table mask_src {
        ...
        const entries = {
            (0x01) : shift(0xFFFFFFFE,0xFFFFFFFF);
            (0x03) : shift(0xFFFFFFF8,0xFFFFFFFC);
            (0x05) : shift(0xFFFFFFE0,0xFFFFFFF0);
            (0x07) : shift(0xFFFFFF80,0xFFFFFFC0);
            (0x09) : shift(0xFFFFFE00,0xFFFFFF00);
            (0x0B) : shift(0xFFFFF800,0xFFFFFC00);
            (0x0D) : shift(0xFFFFE000,0xFFFFF000);
            (0x0F) : shift(0xFFFF8000,0xFFFFC000);
            (0x11) : shift(0xFFFE0000,0xFFFF0000);
            (0x13) : shift(0xFFF80000,0xFFFC0000);
            (0x15) : shift(0xFFE00000,0xFFF00000);
            (0x17) : shift(0xFF800000,0xFFC00000);
            (0x19) : shift(0xFE000000,0xFF000000);
            (0x1B) : shift(0xF8000000,0xFC000000);
            (0x1D) : shift(0xE0000000,0xF0000000);
            (0x1F) : shift(0x80000000,0xC0000000);
        }
        size = 32;
    }
    ...
    Register<Bucket, bit<32>>(16384) Bucket_Array;
...
//计数器数组
    ...
    apply {
        ...
        mask_src.apply();
        if(meta.src_ip_mask == hdr.ipv4.src_addr) {
            meta.right_flag = 0;
        }
        else {
            meta.right_flag = 1;
